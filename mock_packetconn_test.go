...
//
//	mockgen -typed -package quic -self_package github.com/MahamShakir/quic-go-patch -self_package github.com/MahamShakir/quic-go-patch -destination mock_packetconn_test.go net PacketConn
//
